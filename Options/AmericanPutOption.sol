...
/**
 * The AmericanPutOption contract holds the amount unit of the underlying asset multiplied with the 
...
contract CallOption {
  ...
  function useOption () public returns(bool) {
    if(msg.sender == owner && active && block.timestamp >= startTimestamp)
    {
